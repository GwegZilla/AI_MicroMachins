...
namespace ImGui
{
	...
	IMGUI_API bool			InputChar(const char* label, char* v, int step, int step_fast, ImGuiInputTextFlags extra_flags = 0);
	IMGUI_API bool			InputUChar(const char* label, unsigned char* v, int step, int step_fast, ImGuiInputTextFlags extra_flags = 0);
	...
	IMGUI_API bool			SliderChar(const char* label, char* v, int v_min, int v_max, const char* display_format = "%.0f");
	IMGUI_API bool			SliderUchar(const char* label, unsigned char* v, int v_min, int v_max, const char* display_format = "%.0f");
